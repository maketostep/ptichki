    ...
    >
      <div className="flex flex-col items-center relative gap-10">
        <div className="flex flex-col items-center md:mx-25 2xl:mx-0 text-center 2xl:w-[1470px] 2xl:h-[445px] 2xl:gap-[50px]">
          <div className="flex md:flex-row flex-col items-center mt-[52px] md:gap-0 gap-7">
            <h2 className="2xl:text-[66px] xl:text-6xl text-3xl font-extrabold text-white">
              {mainTextInformationBlock}
            </h2>
            <img
              src={heart}
          ...
          <h2 className="2xl:text-[66px] xl:text-5xl 2xl:mt-0 xl:mt-50 mt-15 text-2xl 2xl:leading-[75px] break-words font-bold text-white">
            {secondTextInformationBlock}
          </h2>
        </div>
        <div className="xl:flex 2xl:block flex-row gap-120">
          <img
            src={noteOne}
            alt="note 1"
            className="w-90 md:w-88 xl:w-115 md:h-auto 2xl:w-[637px] 2xl:h-[735px] 2xl:absolute 2xl:mt-0 xl:mt-[44px] top-[600px] left-[148px] object-cover"
          />
          <img
            src={noteTwo}
            alt="note 2"
            className="w-90 md:w-88 xl:w-110 md:h-auto 2xl:w-[637px] 2xl:h-[762px] 2xl:absolute 2xl:mt-0 xl:mt-[44px] top-[600px] left-[1236px] object-cover"
          />
        </div>
        <div className="flex flex-col items-center 2xl:mt-[765px] xl:mt-[125px] md:mt-[100px] space-y-10">
